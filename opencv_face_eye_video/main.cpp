...
String facefile = "F:/opencv/OpenCV3.2/opencv/build/etc/haarcascades/haarcascade_frontalface_alt.xml";
String lefteyefile = "F:/opencv/OpenCV3.2/opencv/build/etc/haarcascades/haarcascade_eye.xml";
String righteyefile = "F:/opencv/OpenCV3.2/opencv/build/etc/haarcascades/haarcascade_eye.xml";
...
int main(int argc, char** argv) {
	if (!face_detector.load(facefile)) {
		printf("could not load face face data...\n");
		return -1;
	}
	if (!leftyeye_detector.load(lefteyefile)) {
		printf("could not load face eye data...\n");
		return -1;
	}
